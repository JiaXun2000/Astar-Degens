...
import {
  createContractEntityASF,
  processTransferASF,
} from "./helpers/AstarStudentFaucet";
import {
  createContractEntitySamui,
  processTransferSamui,
} from "./helpers/SamuiSkywalker";
import {
  createContractEntityAWD,
  processTransferAWD,
} from "./helpers/AstarWeb3Domains";
import {
  createContractEntityNICO,
  processTransferNICO,
} from "./helpers/NikaConqueror";
import {
  createContractEntityANAUT,
  processTransferANAUT,
} from "./helpers/Astarnaut";
import {
  createContractEntityAP,
  processTransferAP,
} from "./helpers/AstarPunks";
import {
  createContractEntityStarCards,
  processTransferStarCards,
} from "./helpers/StarCards";
import {
  createContractEntityASW,
  processTransferASW,
} from "./helpers/AstarSignWitch";
import {
  createContractEntityABA,
  processTransferABA,
} from "./helpers/AstarBoredApes";

import { events } from "./abi/erc721";
import { createAstarDegenContract, processAstarDegenTransfers } from "./helpers/AstarDegens";
import { createAstarCatsContract, processAstarCatsTransfers } from "./helpers/AstarCats";
